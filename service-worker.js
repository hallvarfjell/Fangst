const CACHE='fangst-v0.1.0';
const APP=['./','./index.html','./manifest.webmanifest','./css/app.css','./css/print.css','./js/app.js','./js/db.js','./js/config.js','./icons/icon-192.png','./icons/icon-512.png'];
